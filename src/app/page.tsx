...
function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const subject = encodeURIComponent(`RFP: ${data.get("topic") || "New Project"}`);
        ...
        <div className="rounded-2xl border p-4 shadow-sm sm:p-6">
          ...
          <form className="mt-4 grid gap-3" onSubmit={handleSubmit}>
            ...
            <button 
              ...
              className="group inline-flex items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-6 py-4 text-sm font-bold text-white shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:from-indigo-700 hover:via-purple-700 hover:to-blue-700 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
